...
Dobré svetelné spracovanie hraje v dnešnej dobe rozhodujúcu rolu vo svete hier. 
Jeho dôveryhodnosť je rozhodujúcim faktorom toho, či danú hru spustíme znova, alebo 
už radšej nie. Avšak nie je najľahšie spracovať toľko informácií v žmurknutí oka. 
Technológia prístupná obyčajným ľuďom nie je schopná spracovať každú svetelnú časticu 
zvlásť v zlomku sekundy, preto je potrebné spracovať tieto svetelné efekty iným spôsobom. 
Takýto spôsob by mal zahŕňať dôveryhodné výsledky spolu s čo najnižšou záťažou na naše 
hadware-ové vybavenie.
